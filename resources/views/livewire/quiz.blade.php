    ...
    <form wire:submit.prevent="marck_calculate">
      @if ($scholarship != null)
        ...
        @if($check_answer == true)
              <div class="qus_form">
                <div class="radio_btn" style="height: auto;">
                ...
                <div class="radio_btn" wire:model="cottect_style" style="height: auto;">
              ...
              @endif
            @else
              <div class="radio_btn" style="background: #53f053;" style="height: auto;">
...
{{--
        ...
        <div class="main_exam_footer">
          <button type="button" id="final_sub" wire:click="finish_exams" class="btn btn-success "
  ...
  <div class="col-4 main_questin">
    ...
    <div class="col-4" style="background:#ffffff; height:300px;">
      ...
      <div class="text-center pt-4">
        <button class="btn btn-primary" style="width: 80px;height:40px"><a href="{{App\Models\linkk::first()->base_url.'/student/quiz'}}" style="color: white">Try again</a></button>
